export { HomeSuperAdminSeP } from './homeSuperAdminSeP/HomeSuperAdminSeP';
export { GraficasSuperAdminSeP } from './graficasSuperAdminSeP/GraficasSuperAdminSeP';
export { PacientesSuperAdminSeP } from './pacientesSuperAdminSeP/PacientesSuperAdminSeP';
