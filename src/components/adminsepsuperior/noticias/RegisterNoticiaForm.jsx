...
import { createNoticiaSePSuperior } from '../../../api/SepSuperior/noticiasSEPSuperior';
...
export function RegisterNoticiaForm({ onClose, onReload }) {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            await createNoticiaSePSuperior(dataToSend, auth.token);

            setLoading(false);
            onReload();

            toast.success("¡Noticia registrada correctamente!");
            onClose();
            ...
            if (error.descripcion_previa && error.descripcion_previa.length > 0) {
                ...
                setGeneralError("Error al guardar la noticia. Por favor intenta nuevamente.");
            }
